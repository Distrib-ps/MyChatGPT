<template>
  <div class="register-form-container">
    <h2 class="text-2xl font-bold mb-6 dark:text-white">Inscription</h2>
    
    <form @submit.prevent="handleSubmit" class="space-y-4">
      <div class="form-group">
        <label for="username" class="block text-sm font-medium mb-1 dark:text-gray-300">Nom d'utilisateur</label>
        <input 
          type="text" 
          id="username" 
          v-model="username" 
      ...
      <div class="flex items-center justify-between mt-4">
        ...
        <NuxtLink to="/auth/login" class="text-sm text-blue-600 hover:underline dark:text-blue-400 dark:hover:text-blue-300">
